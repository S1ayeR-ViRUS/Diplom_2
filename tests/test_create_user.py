...
class TestCreateUser:
    ...
    @allure.title('Проверка невозможности создании пользователя, когда он уже зарегистрирован.'
                        'Получаем ошибку 403')
    ...
    @allure.title('Проверка невозможности создании пользователя, когда одно из полей незаполненно.'
                        'Получаем ошибку 403')
